 ...
 */
package net.agef.jobexchange.services.recaptcha;

import java.net.URLEncoder;
import java.util.Enumeration;
import java.util.Properties;

import net.agef.jobexchange.services.recaptcha.http.HttpLoader;
import net.agef.jobexchange.services.recaptcha.http.SimpleHttpLoader;
...
public class ReCaptchaImpl implements ReCaptcha {
	...
	private String privateKey = "6LewjwIAAAAAAMDuSwyCDNWvPObrG16Z7AlJbHNy";
	private String publicKey = "6LewjwIAAAAAAAtTV2hzyVv0T28kLYUao-L5mfnl";
