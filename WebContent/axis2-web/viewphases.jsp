...
<%
         ...
         ArrayList<Phase> tempList = null; //(ArrayList<Phase>) phases.getGlobalInflow();
...
<blockquote>
<%
             tempList = null; //(ArrayList<Phase>) phases.getGlobalInFaultPhases();
             for (int i = 0; i < tempList.size(); i++) {
                 Phase phase = (Phase) tempList.get(i);
         %><%=phase.getPhaseName()%><br>
<%
...
<blockquote>
<%
             tempList = null; //(ArrayList<Phase>) phases.getGlobalOutPhaseList();
             for (int i = 0; i < tempList.size(); i++) {
                 Phase phase = (Phase) tempList.get(i);
         %><%=phase.getPhaseName()%><br>
<%
...
<blockquote>
<%
             tempList = null; // (ArrayList<Phase>) phases.getOUT_FaultPhases();
             for (int i = 0; i < tempList.size(); i++) {
                 Phase phase = (Phase) tempList.get(i);
         %><%=phase.getPhaseName()%><br>
<%
...
<blockquote>
<%
             tempList =  null; //(ArrayList<Phase>) phases.getOperationInFaultPhases();
             for (int i = 0; i < tempList.size(); i++) {
                 Phase phase = (Phase) tempList.get(i);
         %><%=phase.getPhaseName()%><br>
<%
