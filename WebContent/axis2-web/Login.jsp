...
<table class="FULL_BLANK">
	<tr>
		...
		changes done through the administration console will be lost when the
		server is restarted.</font></td>
		<td valign="top" align="left">
		<form method="post" name="LoginForm" action="axis2-admin/login">
		<table class="LOG_IN_FORM">
			<tr>
				<td align="center" colspan="2" bgcolor="#b0b0b0" color="#FFFFFF"><font
			...
			<tr>
				<td align="center" colspan="2"><font color="red">&nbsp;<% if (request.getAttribute("errorMessage") != null) {%><%= request.getAttribute("errorMessage")%>
				<% } %>&nbsp;</font></td>
			</tr>
		</table>
		</form>
